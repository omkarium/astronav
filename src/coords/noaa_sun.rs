//! Sun positional coordinates and time using NOAA algorithms
// Copyright (c) 2024 Venkatesh Omkaram

use std::f64::consts::PI;


/// A Struct to find the Sun Rise, Sun Set and other items using NOAA Algorithms
/// 
...
/// 
/// # Example
/// Calculating the Sun Properties for Rise on May 17th 2024, Chennai India
/// ```
